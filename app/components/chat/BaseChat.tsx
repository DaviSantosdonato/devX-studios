          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[26vh] max-w-chat mx-auto">
                <h1 className="text-5xl text-center font-bold text-devx-elements-textPrimary mb-2">
                  Onde as ideias começam
                </h1>
                <p className="mb-4 text-center text-devx-elements-textSecondary">
            ...
            >
              ...
              >
                <div
                  className={classNames(
                    'shadow-sm border border-devx-elements-borderColor bg-devx-elements-prompt-background backdrop-filter backdrop-blur-[8px] rounded-lg overflow-hidden',
                  )}
                >
                  <textarea
                    ref={textareaRef}
                  ...
                  <div className="flex justify-between text-sm p-4 pt-2">
                    <div className="flex gap-1 items-center">
                      ...
                      >
                        {enhancingPrompt ? (
                          <>
                            <div className="i-svg-spinners:90-ring-with-bg text-devx-elements-loader-progress text-xl"></div>
                  ...
                  {EXAMPLE_PROMPTS.map((examplePrompt, index) => {
                    return (
                      <button
                        ...
                        className="group flex items-center w-full gap-2 justify-center bg-transparent text-devx-elements-textTertiary hover:text-devx-elements-textPrimary transition-theme"
                      >
                        {examplePrompt.text}
