        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 bg-devx-elements-background-depth-2 border border-devx-elements-borderColor rounded shadow-sm min-w-[140px] dropdown-animation">
            ...
            {sortedPreviews.map((preview) => (
              <div
                key={preview.port}
                className="flex items-center px-4 py-2 cursor-pointer hover:bg-devx-elements-item-backgroundActive"
                onClick={() => {
                ...
                <span
                  className={
                    activePreviewIndex === preview.index
                      ...
                      : 'text-devx-elements-item-contentDefault group-hover:text-devx-elements-item-contentActive'
                  }
                >
                  {preview.port}
                </span>
