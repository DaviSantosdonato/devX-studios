  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-devx-elements-item-contentDefault hover:text-devx-elements-item-contentActive hover:bg-devx-elements-item-backgroundActive':
          !selected,
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-devx-elements-item-backgroundActive text-devx-elements-item-contentDefault': !selected,
        'bg-devx-elements-item-backgroundAccent text-devx-elements-item-contentAccent': selected,
      })}
      depth={depth}
